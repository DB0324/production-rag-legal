"""
Embed and index the semantic-chunking chunk set into Qdrant,
...
Run from project root: python -m src.ingestion.run_indexing_semantic
"""
import os
import time
import pandas as pd
...
BM25_OUTPUT = "data/chunks/semantic_bm25.pkl"
